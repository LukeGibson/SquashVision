...
def playVideo():
    global panelA, panelB, root, currCapture, currVidOp, pause, nextFrame, stop, predPoints, trackPoints, anglePoints, rateAnglePoints, gradPoints, rateGradPoints, deltaPoints, contactFrames, frameIndex
        ...
        if not pause or nextFrame:
            ...
            if not ret:
                ...
                if currVidOp.get() == 'Make Decision':
                    ...
                    print("Contact frames: gradient", contactFrames)
...
def genLineVid(frame):
    global bgSubMOG, trackPoints, frameIndex, linePoints
...
def genTrackVid(frame):
    global bgSubMOG, trackPoints, lastSeenBall
